/* ============================================================
   ...
   nav.js reads this to render:
     ...
     - the unit-meta line (unit - readings - exam scope)
   ...
   `covered` is the list of units taught so far — see below.
   ============================================================ */
window.COURSE = {
  code:        "ECON 3049",
  ...
  /* --- Units covered in class, by unit code. ---------------------------
     ...
     that unit and the home page tells students where the class has got to.
     Order is irrelevant — the roadmap renders in course order either way.
     A code that matches no unit fails dev/check-site.mjs, so a typo here
  ...
  units: [
    { unit: "1A", part: "1", slug: "1a-introducing-econometrics",
    ...
    { unit: "1B", part: "1", slug: "1b-simple-linear-regression",
    ...
    { unit: "1C", part: "1", slug: "1c-ols-assumptions-goodness-of-fit",
    ...
    { unit: "1D", part: "1", slug: "1d-multiple-regression",
    ...
    { unit: "1E", part: "1", slug: "1e-normality-maximum-likelihood",
    ...
    { unit: "1F", part: "1", slug: "1f-statistical-inference",
    ...
    { unit: "2A Part 1", part: "2", slug: "2a-part1-specification",
    ...
    { unit: "2A Part 2", part: "2", slug: "2a-part2-functional-form",
    ...
    { unit: "2B", part: "2", slug: "2b-multicollinearity",
    ...
    { unit: "2D", part: "2", slug: "2d-autocorrelation",
    ...
    { unit: "3A", part: "3", slug: "3a-qualitative-variables",
